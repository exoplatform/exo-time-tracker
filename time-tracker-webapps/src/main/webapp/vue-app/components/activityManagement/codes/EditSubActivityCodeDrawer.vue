...
export default {
  ...
  methods: {
    save() {
      ...
      this.$refs.editSubActivityCodeDrawer.close();
    },
    cancel() {
      this.subActivityCode = this.defaultItem;
      this.$refs.editSubActivityCodeDrawer.close();
    },
    open(subActivityCode) {
      this.subActivityCode = subActivityCode;
      this.$refs.editSubActivityCodeDrawer.open();
    },
  }
};
</script>
